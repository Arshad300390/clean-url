...
if (isset($_POST["submit_btn"])) {
    ...
    $sql = "INSERT INTO tbl_post (post_title, post_text, post_url) VALUES
       ('" . $post_title . "', '" . $post_text . "', '" . php_slug($post_title) . "')";
    if (mysqli_query($connect, $sql)) {
        header("location:/clean-url/post/" . php_slug($post_title) . "?post_url=" . $post_title);
    }
}
